...
class SuperluminalLaser(ThreeDScene):
    def construct(self):
        ...
        emitter = Sector(outer_radius=0.5, angle=PI, start_angle=0, color=DARK_GRAY, fill_opacity=1).move_to(emitter_pos)
