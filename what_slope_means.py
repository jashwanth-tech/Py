"""
What Does Slope REALLY Mean? (Revised & Hardened)
=================================================
A mathematically rigorous 9:16 vertical explainer (1080x1920) for Manim CE.

Revisions:
- Clamped tangent x-range to [0.75, 3.8] (zero below-axis leakage).
- Independent full-length Δy bars for m = 0.5, 1.0, 2.0 (no cumulative illusion).
- Directional Fade transitions eliminate glyph-melting artifacts.
- Multi-column formatting prevents text card overflows on narrow 9:16 viewports.
- Cross-version compatible decimal_number_config for axis numbering.
"""
...
class WhatSlopeReallyMeans(Scene):
    def construct(self):
        ...
        # Helper for clean subtitle transitions (no glyph melting)
        ...
        # -----------------------------------------------------------
        # Coordinate Plane (Cross-version compatible)
        # -----------------------------------------------------------
        axes = Axes(
            x_range=[0, 4.5, 1],
            y_range=[0, 6.0, 1],
            ...
            axis_config={
                ...
                "decimal_number_config": {"font_size": 16},
            },
        ...
        # Move points simultaneously along respective axes
        self.play(
        ...
        # Animate two discrete steps (+1 run -> +2 rise)
        ...
        # Three INDEPENDENT vertical bars, each from y=0 to its line's true height
        # Slightly offset horizontally (x = 1.88, 2.0, 2.12) to avoid visual stacking
        ...
        # 3-column breakdown to avoid text overflow
        ...
        # Iteration 1: Δx = 2.0 (x = 3.5, slope = 1.25)
        ...
        # Iteration 2: Δx = 1.0 (x = 2.5, slope = 1.00)
        ...
        # Iteration 3: Δx = 0.3 (x = 1.8, slope = 0.83)
        ...
        # Tangent slope: 2 * 0.25 * 1.5 = 0.75
        # Range is strictly clamped to [0.75, 3.8] so y >= 0 everywhere!
        ...
        # Clear, bounded lines that do not risk overflow
